export default function Sidebar(props) {
  ...
  const buttonTitle = "+ Create New Board"
    ...
    <nav className={className}>
      <div className="sidebar__nav-wrapper">
        ...
        <button className="button sidebar-button sidebar-button--new-board">
          {boardIcon}
          <div className="sidebar-button__text">{buttonTitle}</div>
        </button>
      </div>

      <button className="button sidebar-button sidebar-button--hide-sidebar" onClick={props.hideSidebar}>
        <svg className='sidebar-button__icon sidebar-button__icon--hide' stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
