    ...
    return (
        <div className="edit-board-menu--wrapper" ref={ellipsisWrapperRef}>
            ...
            <div className={optionsClassName}>
                <div className="button edit-board-menu--edit" onClick={handleClickEdit}>Edit Board</div>
                <div className="button edit-board-menu--delete" onClick={handleClickDelete}>Delete Board</div>
            </div>
        </div>
    )
}